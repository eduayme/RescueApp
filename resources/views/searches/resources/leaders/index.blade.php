...
<div id="with_leader" class="container margin-top padding-bottom">
    <div id="leaders_success_message_container" class="alert alert-success alert-dismissible fade show" role="alert" style="display:none">
        <div class="container text-center">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <span id="leaders_add_success" style="display:none">{{ __('leader.leader_add_success') }}</span>
            <span id="leaders_edit_success" style="display:none">{{ __('leader.leader_edit_success') }}</span>
            <span id="leaders_delete_success" style="display:none">{{ __('leader.leader_delete_success') }}</span>
        </div>
    </div>
