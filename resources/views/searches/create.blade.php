                ...
                <div class="wrapper">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea type="text" class="form-control" name="physical_appearance[]" rows="2">{{ old('physical_appearance.0') }}</textarea>
                        </div>
                        <!--  Aspect description - CLOSE  -->
                        <!-- Clothes - OPEN  -->
                        <div class="form-group col-md-6">
                            <label for="clothes"> {{ __('forms.clothes') }} </label>
                            <textarea type="text" class="form-control" name="clothes[]" rows="2">{{ old('clothes.0') }}</textarea>
                        </div>
                        <!-- Clothes - CLOSE  -->
                        <!-- Phisic form - OPEN  -->
                        <div class="form-group col-md-6">
                            <label for="physical_condition"> {{ __('forms.phisic_form') }} </label>
                            <textarea type="text" class="form-control" name="physical_condition[]" rows="2">{{ old('physical_condition.0') }}</textarea>
                        </div>
                        <!-- Phisic form - CLOSE  -->
                        <!-- Diseases or injuries - OPEN  -->
                        <div class="form-group col-md-6">
                            <label for="diseases_or_injuries"> {{ __('forms.diseases_or_injuries') }} </label>
                            <textarea type="text" class="form-control" name="diseases_or_injuries[]" rows="2">{{ old('diseases_or_injuries.0') }}</textarea>
                        </div>
                        <!-- Diseases or injuries - CLOSE  -->
                        <!-- Medication - OPEN  -->
                        <div class="form-group col-md-6">
                            <label for="medication"> {{ __('forms.medication') }} </label>
                            <textarea type="text" class="form-control" name="medication[]" rows="2">{{ old('medication.0') }}</textarea>
                        </div>
                        <!-- Medication - CLOSE  -->
                        <!-- Limitations or discapacities - OPEN  -->
                        <div class="form-group col-md-6">
                            <label for="discapacities_or_limitations"> {{ __('forms.limitations_or_discapacities') }} </label>
                            <textarea type="text" class="form-control" name="discapacities_or_limitations[]" rows="2">{{ old('discapacities_or_limitations.0') }}</textarea>
                        </div>
                        <!-- Limitations or discapacities - CLOSE  -->
                        <!-- Others - OPEN  -->
                        <div class="form-group col-md-12">
                            <label for="other"> {{ __('forms.other') }} </label>
                            <textarea type="text" class="form-control" name="other[]" rows="2">{{ old('other.0') }}</textarea>
                        </div>
                        <!-- Others - CLOSE  -->
                        <!-- Vehicle title - OPEN -->
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control {{ $errors->has('model_vehicle') ? ' is-invalid' : '' }}" name="model_vehicle[]" value="{{ old('model_vehicle.0') }}"/>
                        </div>
                        <!-- Vehicle model and brand - CLOSE  -->
                        <!-- Vehicle color - OPEN  -->
                        <div class="form-group col-md-3">
                            <label for="color_vehicle"> {{ __('forms.color') }} </label>
                            <input type="text" class="form-control {{ $errors->has('color_vehicle') ? ' is-invalid' : '' }}" name="color_vehicle[]" value="{{ old('color_vehicle.0') }}"/>
                        </div>
                        <!-- Vehicle color - CLOSE  -->
                        <!-- Vehicle license plate - OPEN  -->
                        <div class="form-group col-md-3">
                            <label for="car_plate_number"> {{ __('forms.license_plate') }} </label>
                            <input type="text" class="form-control {{ $errors->has('car_plate_number') ? ' is-invalid' : '' }}" name="car_plate_number[]" value="{{ old('car_plate_number.0') }}"/>
                        </div>
