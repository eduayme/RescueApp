...
<div class="form-row margin-top text-left">
    ...
    <div class="form-group margin-top-bottom col-md-3">
        <p>
    ...
    <div class="form-group margin-top-bottom col-md-6">
        <p>
    ...
    <!-- Group - OPEN  -->
    <div class="form-group margin-top-bottom col-md-4">
        <p>
            {{ __('forms.group') }}
        </p>
        <h5 class="margin-top-sm-min">
    ...
    <div class="form-group margin-top-bottom col-md-2">
        <p>
            {{ __('forms.utm_x') }}
        </p>
        <h5 class="margin-top-sm-min">
